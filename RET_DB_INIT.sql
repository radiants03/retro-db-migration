...
CREATE TABLE `board` (
  ...
  `show_like` tinyint DEFAULT '1',
  `show_comments` tinyint DEFAULT '1',
...
CREATE TABLE `card` (
  ...
  CONSTRAINT `card_ibfk_1` FOREIGN KEY (`category_id`) REFERENCES `category` (`id`) ON DELETE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `comment` (
  ...
  PRIMARY KEY (`id`),
  KEY `card_id` (`card_id`),
  CONSTRAINT `comment_ibfk_1` FOREIGN KEY (`card_id`) REFERENCES `card` (`id`) ON DELETE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2025-02-15 12:32:25
